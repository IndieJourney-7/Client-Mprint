...
const AdminPanel = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50/30 to-purple-50/20">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div className="flex items-center space-x-4">
              <div className="flex items-center justify-center w-12 h-12 rounded-2xl bg-gradient-to-br from-blue-600 to-purple-600 shadow-lg shadow-blue-500/30">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 mt-0.5">Manage your ecommerce platform</p>
              </div>
            </div>
            <div className="flex items-center space-x-2">
              <button
                ...
                disabled={loading}
                className="group relative p-2.5 rounded-xl bg-white border border-gray-200 hover:border-blue-300 hover:shadow-md transition-all disabled:opacity-50"
                title="Refresh Data"
              >
                <IoRefresh size={18} className={`text-gray-600 group-hover:text-blue-600 transition ${loading ? 'animate-spin' : ''}`} />
              </button>
              <a
                href="/"
                className="group relative p-2.5 rounded-xl bg-white border border-gray-200 hover:border-blue-300 hover:shadow-md transition-all"
                title="Go to Website"
              >
                <IoHome size={18} className="text-gray-600 group-hover:text-blue-600 transition" />
              </a>
            </div>
          </div>
        </div>
      ...
      <div className="sticky top-[73px] z-30 backdrop-blur-xl bg-white/80 border-b border-gray-200/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <nav className="flex space-x-1">
            {[
              { id: 'products', icon: IoAppsOutline, label: 'Products', count: products.length },
              { id: 'categories', icon: IoGridOutline, label: 'Categories', count: categories.length },
              { id: 'banners', icon: IoImageOutline, label: 'Banners', count: null },
              { id: 'offers', icon: IoMegaphoneOutline, label: 'Offer Bars', count: null },
              { id: 'analytics', icon: IoStatsChartOutline, label: 'Analytics', count: null }
            ].map((tab) => (
              <button
                key={tab.id}
                onClick={() => setCurrentSection(tab.id)}
                className={`relative py-4 px-4 font-medium text-sm flex items-center gap-2 transition-all ${
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {error && !showForm && (
          <div className="mb-6 animate-in slide-in-from-top duration-300">
            <div className="bg-gradient-to-r from-red-50 to-pink-50 border border-red-200 rounded-2xl px-4 py-3">
              <div className="flex items-start">
                <IoCloseCircle className="mr-3 mt-0.5 text-red-600 flex-shrink-0" size={20} />
        ...
        {currentSection === 'analytics' && (
          <div className="space-y-6">
            <div className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-sm border border-gray-200/50 p-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                {[
                  ...
                  <div key={idx} className={`relative overflow-hidden rounded-2xl bg-gradient-to-br ${stat.bg} p-6 border border-gray-200/50 hover:shadow-lg transition-shadow`}>
              ...
              <div className="text-center py-12">
                <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-gray-100 to-gray-200 mb-4">
                  <IoStatsChartOutline size={32} className="text-gray-400" />
                </div>
                <p className="text-gray-500 font-medium">More detailed analytics coming soon...</p>
              </div>
            </div>
          </div>
        )}
