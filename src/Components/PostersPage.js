...
import { FaRegHeart, FaHeart, FaStar, FaImage } from "react-icons/fa";
    ...
    const fetchPostersProducts = async () => {
      ...
      try {
        const response = await fetch(
          `${API_BASE_URL}/products/category/posters`,
          {
            method: "GET",
    ...
    <div className="px-6 md:px-10 py-10 bg-gradient-to-b from-amber-50 to-gray-50 min-h-screen">
      ...
      {products.length === 0 ? (
        <div className="max-w-2xl mx-auto text-center py-16">
          ...
          <p className="text-gray-600 mb-6">We're working on adding custom posters. Check back soon!</p>
          <Link
            to="/"
